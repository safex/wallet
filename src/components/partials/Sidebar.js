          ...
          <div className="content-inner">
            <div className={this.state.general ? "general" : "general hidden"}>
              ...
              <p className="general-p">
                Orbiter Wallet {remote.app.getVersion()}
              </p>
            </div>
            ...
            <div
              className={
                this.state.seed_keys
                  ? "seed-keys-wrap"
                  : "seed-keys-wrap hidden"
              }
            >
              <h2>Seed And Keys</h2>
              ...
              <div className="label-wrap">
                ...
                <ReactTooltip place="right" id="mnemonic-tooptip">
                  ...
                  <p className="mb-10">
                    It contains <span className="blue-text">24 or 25</span>{" "}
              ...
              <div className="label-wrap">
                ...
                <ReactTooltip place="right" id="public-view-tooptip">
                  <p>
                    <span className="blue-text">Public Spend Key</span> and{" "}
                    <span className="blue-text">Public View Key</span> are made
              ...
              <div className="button-wrap">
                <p>
                  Rescan blockchain from the begining. This is performed when
                  your wallet file is created. Use this if you suspect your
                  wallet file is corrupted or missing data. It may take a lot of
                  time to complete.
                </p>
                <button
              ...
              <div className="button-wrap">
                <p>
                  ...
                  loss of your Cash and Tokens. It is a very sensitive file,
